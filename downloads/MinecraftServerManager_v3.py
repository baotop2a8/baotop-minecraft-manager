...
LANGUAGES = {
    "English": {
        ...
        "clear": "🗑 Clear", "console": "📜 Live Console",
    },
    "Tiếng Việt": {
        ...
        "clear": "🗑 Xóa", "console": "📜 Console trực tiếp",
    },
    "日本語": {
...
class AppSettingsDialog(ctk.CTkToplevel):
    def __init__(self, master, app, language_only=False):
        ...
        self.title(tr("language") if language_only else tr("settings"))
        self.geometry("430x250" if language_only else "430x320")
        ...
        ctk.CTkLabel(card,
                     text=("🌐 " + tr("language")) if language_only else ("☰ " + tr("settings")),
        ...
        if not language_only:
            ...
            self.appearance_menu = ctk.CTkOptionMenu(
                ...
                button_hover_color=p["button_hover"], command=self._preview_appearance)
    ...
    def _preview_appearance(self, value):
        self.app.set_appearance(value, refresh_dialogs=False)

    def _apply(self):
        appearance = self.appearance_var.get() if not self.language_only else APP_SETTINGS["appearance"]
...
class ServerAdminDialog(tk.Toplevel):
    def __init__(self, master, name, entry, get_running, app=None):
        ...
        notebook.add(self.env_tab, text="  World & Backup  ")
...
class ServerManagerApp(tk.Tk):
    ...
    def _open_language_settings(self):
        self._register_secondary(AppSettingsDialog(self, self, language_only=True))
    ...
    def _build_ui(self):
        ...
        self.language_btn = ctk.CTkButton(
            utility_bar, text="🌐", width=48, height=38, corner_radius=9,
            fg_color="#374151", hover_color="#4B5563", command=self._open_language_settings)
        self.language_btn.pack(side="right", padx=(4, 0))
