...
class AppSettingsDialog(ctk.CTkToplevel):
    ...
    def _apply(self):
        ...
        # The menu displays localized labels, but settings keep canonical values.
        appearance_key = None
        if appearance in ("Dark", "Light"):
            appearance_key = appearance
        elif appearance == tr("dark"):
            appearance_key = "Dark"
        elif appearance == tr("light"):
            appearance_key = "Light"
        else:
            appearance_key = "Dark"
        self.app.apply_preferences(appearance_key, self.language_var.get())
        self.destroy()
